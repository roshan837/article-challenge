<template>
  ...
  >
    ...
    <div 
      ...
      :class="{
        'w-full h-80 sm:h-96 md:h-[28rem] lg:h-[32rem] rounded-t-lg': viewMode === 'list',
    ...
    >
      ...
      <div 
        ...
        :class="{ 'rounded-t-lg': viewMode === 'list', 'rounded-t-xl': viewMode === 'grid' }"
      />
    </div>
    ...
    >
      <!-- Title -->
      <h2 
        class="font-semibold text-gray-900 group-hover:text-primary-600 transition-colors duration-200 text-clamp-2 leading-tight"
        :class="{
      ...
      <div v-if="viewMode === 'list'" class="flex items-center justify-between">
        ...
        <!-- Read More -->
        <button 
          class="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium transition-colors duration-200 focus-ring rounded-md text-xs px-1 py-0.5"
